            ...
            if isinstance(json_data, dict):
                if 'tag' in json_data:
                    ...
                    if 'text' in json_data:
                        if get_translation(json_data['text'].strip()):
                            print(f'Got {json_data["text"].strip()} from dictionary.')
                            json_data['text'] = get_translation(json_data['text'].strip())
                        else:
                            add_translation(json_data['text'].strip(), translate_term(json_data['text'].strip(), "hi"))
                            json_data['text'] = get_translation(json_data['text'].strip())
